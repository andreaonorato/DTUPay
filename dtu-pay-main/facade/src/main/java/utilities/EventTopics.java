...
public class EventTopics {
    ...
    public static final String TOKEN_ISSUED = "TokenIssued";
    public static final String TOKEN_NOT_ISSUED = "TokenNotIssued";
    public static final String CUSTOMER_NOT_REGISTERED = "CustomerNotRegistered";
    public static final String CUSTOMER_DOES_NOT_EXIST = "CustomerDoesNotExist";
    public static final String ISSUE_TOKEN_REQUESTED = "IssueTokenRequested";
    ...
    public static final String MERCHANT_NOT_REGISTERED = "MerchantNotRegistered";
    public static final String MERCHANT_DOES_NOT_EXIST = "MerchantDoesNotExist";
    ...
    public static final String MONEY_NOT_TRANSFERRED = "MoneyNotTransferred";
